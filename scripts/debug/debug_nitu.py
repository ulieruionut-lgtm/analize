"""Compara datele Nitu din DB cu conținutul așteptat."""
...
for p in rows:
    ...
    for b in buletine:
        ...
        for z in rez:
            ...
            print(f"    {z['denumire_raw'][:55]:55} -> {v} {z['unitate'] or '':8} | {z['denumire_standard'] or '-'}")
